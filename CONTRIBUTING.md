...
on Linux by [Travis](https://travis-ci.org/houseabsolute/perl-code-tidyall) and on Windows by [AppVeyor](https://ci.appveyor.com/project/autarch/perl-code-tidyall).
